...
For example, here is an uncertain surface.  The datapoints have a gap in the middle.  The _entire_ surface is animated, but it moves more in the gap because the uncertainty is higher.
