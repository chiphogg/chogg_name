...
For instance, I use a [pandoc](http://johnmacfarlane.net/pandoc/) filter to turn the output of knitr into HTML for my website.
...
Over the years, people have developed [a confusing array of not-quite-satisfactory workarounds](http://stackoverflow.com/questions/540535/managing-large-binary-files-with-git).
...
For example, [Carl Boettiger](http://www.carlboettiger.info/) has maintained an [open lab notebook](http://www.carlboettiger.info/2012/09/28/Welcome-to-my-lab-notebook.html) for years, and I'm sure there are many other examples which I haven't yet seen.
