The [Cholesky decomposition](http://en.wikipedia.org/wiki/Cholesky_decomposition) is a key concept in matrix algebra.
...
At this point, I'm reminded of [mathematical induction](http://en.wikipedia.org/wiki/Mathematical_induction): a method to generate "valid for any positive integer" proofs based on two ingredients.
...
[^block]:
  Note that this is a [block matrix](http://en.wikipedia.org/wiki/Block_matrix): one whose elements stand for other matrices.
