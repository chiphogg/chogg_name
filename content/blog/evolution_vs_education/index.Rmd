...
The data come from [a 2006 Science paper](http://www.sciencemag.org/content/313/5788/765.summary) which combined a variety of surveys from recent years.
The 32 European countries come from the [Eurobarometer survey 63.1](http://www.icpsr.umich.edu/icpsrweb/ICPSR/studies/4563).
...
[Canadian belief in evolution](http://angusreid.org/americans-are-creationists-britons-and-canadians-side-with-evolution/) is significantly higher than in the US (61% vs. 40%), while their [GDP](https://www.cia.gov/library/publications/the-world-factbook/rankorder/2004rank.html) is somewhat lower (\$44,500 vs. \$54,800).
...
To find out, I checked the 2010 OECD World Education Rankings, which [The Guardian visualizes nicely here](http://www.theguardian.com/news/datablog/2010/dec/07/world-education-rankings-maths-science-reading).
